...
const MAP_CONFIGS: Record<MapKey, MapConfig> = {
    ...
    Mirak_Valley: {
        ...
        team1HeliSpawns: [                        //posX      posY      posZ                             rotX      rotY      rotZ
            ...
            { slotNumber: 3, pos: mod.CreateVector(-512.883,  80.713,  -269.728), rot: mod.CreateVector( 0.0,      61.967,   0.0),       vehicle: mod.VehicleList.AH6M         },
        ...
        team2HeliSpawns: [                        //posX      posY      posZ                             posX      posY      posZ
            ...
            { slotNumber: 3, pos: mod.CreateVector( 496.253,  83.173,  -600.711), rot: mod.CreateVector( 0.0,     -90.251,   0.0),       vehicle: mod.VehicleList.AH6M         },
    ...
    Operation_Firestorm: {
        ...
        team1HeliSpawns: [                        //posX      posY      posZ                             rotX      rotY      rotZ
            ...
            { slotNumber: 3, pos: mod.CreateVector(-782.131,  132.861,  198.011), rot: mod.CreateVector( 0.0,      48.206,   0.0),       vehicle: mod.VehicleList.AH6M         },
        ...
        team2HeliSpawns: [                        //posX      posY      posZ                             posX      posY      posZ
            ...
            { slotNumber: 3, pos: mod.CreateVector( 647.500,  110.562, -276.828), rot: mod.CreateVector( 0.0,     -126.059,  0.0),       vehicle: mod.VehicleList.AH6M         },
    ...
    Liberation_Peak: {
        ...
        team1HeliSpawns: [                        //posX      posY      posZ                             rotX      rotY      rotZ
            ...
            { slotNumber: 3, pos: mod.CreateVector(-326.491,  129.927,  82.657),  rot: mod.CreateVector( 0.0,     -23.622,   0.0),       vehicle: mod.VehicleList.AH6M         },
        ...
        team2HeliSpawns: [                        //posX      posY      posZ                             posX      posY      posZ
            ...
            { slotNumber: 3, pos: mod.CreateVector( 288.061,  139.34,   447.63),  rot: mod.CreateVector( 0.0,     -152.953,  0.0),       vehicle: mod.VehicleList.AH6M         },
    ...
    Manhattan_Bridge: {
        ...
        team1HeliSpawns: [                        //posX      posY      posZ                             rotX      rotY      rotZ
            ...
            { slotNumber: 3, pos: mod.CreateVector(-330.070,  52.162,  -440.936), rot: mod.CreateVector( 0.0,      90.418,   0.0),       vehicle: mod.VehicleList.AH6M         },
        ...
        team2HeliSpawns: [                        //posX      posY      posZ                             posX      posY      posZ
            ...
            { slotNumber: 3, pos: mod.CreateVector( 186.823,  57.278,  -211.892), rot: mod.CreateVector( 0.0,     -178.709,  0.0),       vehicle: mod.VehicleList.AH6M         },
    ...
    Sobek_City: {
        ...
        team1HeliSpawns: [                        //posX      posY      posZ                             rotX      rotY      rotZ
            ...
            { slotNumber: 3, pos: mod.CreateVector(-313.32,   92.297,  -73.7171), rot: mod.CreateVector( 0.0,      113.958,  0.0),       vehicle: mod.VehicleList.AH6M         },
        ...
        team2HeliSpawns: [                        //posX      posY      posZ                             posX      posY      posZ
            ...
            { slotNumber: 3, pos: mod.CreateVector( 225.784,  91.31,    36.228),  rot: mod.CreateVector( 0.0,      140.278,  0.0),       vehicle: mod.VehicleList.AH6M         },
