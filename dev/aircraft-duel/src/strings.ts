...
// Per-spawner knob grid (in-roster). Widget name = PREFIX + knobKey + "_" + pid (knobKey e.g. "team1Heli3").
const UI_RD_KNOB_LABEL_ID = "UI_RD_KNOB_LABEL_";
const UI_RD_KNOB_VALUE_ID = "UI_RD_KNOB_VALUE_";
const UI_RD_KNOB_DEC_ID = "UI_RD_KNOB_DEC_";
const UI_RD_KNOB_DEC_LABEL_ID = "UI_RD_KNOB_DEC_LABEL_";
const UI_RD_KNOB_INC_ID = "UI_RD_KNOB_INC_";
const UI_RD_KNOB_INC_LABEL_ID = "UI_RD_KNOB_INC_LABEL_";
...
// Symmetric-count guard notice -- red text shown when T1 and T2 pending vehicle counts differ.
const UI_READY_DIALOG_SYMMETRIC_WARNING_ID = "UI_READY_DIALOG_SYMMETRIC_WARNING_";
// "First to X Vehicle Kills" readout in the top-left header block (replaces the old matchup row text).
const UI_READY_DIALOG_FIRST_TO_KILLS_ID = "UI_READY_DIALOG_FIRST_TO_KILLS_";
