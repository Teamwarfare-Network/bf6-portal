...
import './clock/state';
import './clock/ui';
import './team-switch/types';
import './team-switch/interact-point';
import './team-switch/actions';
import './team-switch/ui-events-ready';
import './team-switch/ui-events-admin';
import './team-switch/ui-events';
import './ready-dialog/dialog-build';
import './ready-dialog/admin-panel-build';
import './ready-dialog/roster-render';
import './ready-dialog/mode-config';
