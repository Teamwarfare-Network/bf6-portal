...
function getActivePlayers(): ActivePlayers_t {
    ...
    for (let i = 0; i < count; i++) {
        ...
        // Spectator stays in the roster (their `readyByPid[pid]` is set to true on claim,
        // so they don't block areAllActivePlayersReady). The dialog row renderer in
        // roster-render.ts shows "Spectator" instead of "READY" for this pid.
