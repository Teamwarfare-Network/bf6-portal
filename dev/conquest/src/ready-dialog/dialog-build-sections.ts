...
function buildReadyDialogHeaderAndMapSection(
    ...
    addReadyDialogText(
        ...
        mod.UIAnchor.TopLeft,
        msg(mod.stringkeys.twl.readyDialog.header),
        eventPlayer,
        containerBase,
        20,
        false,
    ...
    addReadyDialogText(
        ...
        mod.UIAnchor.TopLeft,
        mod.UIAnchor.TopLeft,
        msg(mod.stringkeys.twl.readyDialog.header2),
        eventPlayer,
        containerBase,
        16,
        false,
    ...
    addReadyDialogText(
        ...
        mod.UIAnchor.TopLeft,
        mod.UIAnchor.TopLeft,
        msg(mod.stringkeys.twl.readyDialog.header3),
        eventPlayer,
        containerBase,
        16,
        false,
    ...
    addReadyDialogText(
        ...
        mod.UIAnchor.TopLeft,
        mod.UIAnchor.TopLeft,
        msg(mod.stringkeys.twl.readyDialog.header4, Math.floor(VEHICLE_SPAWNER_KEEP_ALIVE_ABANDON_RADIUS)),
        eventPlayer,
        containerBase,
        16,
        false,
    ...
    addReadyDialogText(
        ...
        mod.UIAnchor.TopLeft,
        mod.UIAnchor.TopLeft,
        msg(mod.stringkeys.twl.readyDialog.header5),
        eventPlayer,
        containerBase,
        16,
        false,
    ...
    addReadyDialogText(
        ...
        mod.UIAnchor.TopLeft,
        mod.UIAnchor.TopLeft,
        msg(mod.stringkeys.twl.readyDialog.header6),
        eventPlayer,
        containerBase,
        16,
        false,
    ...
    addReadyDialogText(
        ...
        msg(mod.stringkeys.twl.readyDialog.mapLabel),
        eventPlayer,
        mod.GetUIRoot(),
        12,
        false,
    ...
    addReadyDialogText(
        ...
        mod.UIAnchor.TopRight,
        mod.UIAnchor.CenterLeft,
        msg(getMapNameKey(ACTIVE_MAP_KEY)),
        eventPlayer,
        mod.GetUIRoot(),
        12,
        false,
