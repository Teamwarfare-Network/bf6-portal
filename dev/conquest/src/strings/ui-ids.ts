...
// CQ_Bug_52 temporary diagnostic counter widget (admin panel only). Remove with the rest of CQ52 telemetry.
const UI_ADMIN_CQ52_COUNTER_ID = "UI_ADMIN_CQ52_COUNTER_";
