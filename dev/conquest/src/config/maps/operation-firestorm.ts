...
const MAP_CONFIG_FRAGMENT_OPERATION_FIRESTORM = {
    ...
    Operation_Firestorm: {
        ...
        team1AircraftSpawnVolumes: [
            {
                ...
                heliSpawnCeiling: 100.0,
                jetSpawnFloor: 400.0,
                jetSpawnCeiling: 800.0,
                rotHeli: mod.CreateVector(0.0, 105.178, 0.0),
                rotPlaneN: mod.CreateVector(0.0, 0.0, 0.0),
                rotPlaneE: mod.CreateVector(0.0, 90.0, 0.0),
                rotPlaneW: mod.CreateVector(0.0, -90.0, 0.0),
                rotPlaneS: mod.CreateVector(0.0, 180.0, 0.0),
            },
        ],
        team2AircraftSpawnVolumes: [
            {
                ...
                jetSpawnFloor: 400.0,
                jetSpawnCeiling: 800.0,
                rotHeli: mod.CreateVector(0.0, -49.401, 0.0),
                rotPlaneN: mod.CreateVector(0.0, 0.0, 0.0),
                rotPlaneE: mod.CreateVector(0.0, 90.0, 0.0),
                rotPlaneW: mod.CreateVector(0.0, -90.0, 0.0),
                rotPlaneS: mod.CreateVector(0.0, 180.0, 0.0),
        ...
        team1FastMoverSpawns: [
            { slotNumber: 1, pos: mod.CreateVector(0.0, 0.0, 0.0), rot: mod.CreateVector(0.0, 0.0, 0.0), vehicle: mod.VehicleList.Flyer60 },
            { slotNumber: 2, pos: mod.CreateVector(0.0, 0.0, 0.0), rot: mod.CreateVector(0.0, 0.0, 0.0), vehicle: mod.VehicleList.Flyer60 },
            { slotNumber: 3, pos: mod.CreateVector(0.0, 0.0, 0.0), rot: mod.CreateVector(0.0, 0.0, 0.0), vehicle: mod.VehicleList.Flyer60 },
            { slotNumber: 4, pos: mod.CreateVector(0.0, 0.0, 0.0), rot: mod.CreateVector(0.0, 0.0, 0.0), vehicle: mod.VehicleList.Flyer60 },
        ],
