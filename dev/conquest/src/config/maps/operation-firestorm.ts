...
const MAP_CONFIG_FRAGMENT_OPERATION_FIRESTORM = {
    ...
    Operation_Firestorm: {
        ...
        mainBaseInteractableAnchors: [
            { objId: 1000, ownerTeamId: TeamID.Team2, pos: mod.CreateVector(543.660, 114.503, -222.605) },
            { objId: 1001, ownerTeamId: TeamID.Team2, pos: mod.CreateVector(540.783, 114.503, -225.179) },
            { objId: 1002, ownerTeamId: TeamID.Team2, pos: mod.CreateVector(576.474, 113.856, -179.954) },
            { objId: 1003, ownerTeamId: TeamID.Team2, pos: mod.CreateVector(572.784, 113.856, -181.087) },
            { objId: 1004, ownerTeamId: TeamID.Team2, pos: mod.CreateVector(642.969, 112.215, -245.541) },
            { objId: 1005, ownerTeamId: TeamID.Team2, pos: mod.CreateVector(640.976, 112.408, -242.724) },
            { objId: 1006, ownerTeamId: TeamID.Team2, pos: mod.CreateVector(565.159, 113.899, -281.681) },
            { objId: 1007, ownerTeamId: TeamID.Team2, pos: mod.CreateVector(561.822, 113.899, -279.824) },
            { objId: 1008, ownerTeamId: TeamID.Team1, pos: mod.CreateVector(-810.319, 134.252, 200.224) },
            { objId: 1009, ownerTeamId: TeamID.Team1, pos: mod.CreateVector(-809.334, 134.266, 203.858) },
            { objId: 1010, ownerTeamId: TeamID.Team1, pos: mod.CreateVector(-756.764, 134.248, 161.880) },
            { objId: 1011, ownerTeamId: TeamID.Team1, pos: mod.CreateVector(-759.567, 134.258, 159.426) },
            { objId: 1012, ownerTeamId: TeamID.Team1, pos: mod.CreateVector(-712.187, 134.310, 201.762) },
            { objId: 1013, ownerTeamId: TeamID.Team1, pos: mod.CreateVector(-715.728, 134.284, 200.155) },
            { objId: 1014, ownerTeamId: TeamID.Team1, pos: mod.CreateVector(-774.771, 133.960, 278.100) },
            { objId: 1015, ownerTeamId: TeamID.Team1, pos: mod.CreateVector(-771.480, 133.919, 279.972) },
        ],
        ...
        gadgetInteractableAnchors: [
            ...
            { objId: 1056, ownerTeamId: 0, pos: mod.CreateVector(-729.66, 134.095, 202.982) },
            { objId: 1057, ownerTeamId: 0, pos: mod.CreateVector(602.479, 111.496, -222.861) },
        ],
        aircraftCeiling: 130,
        hudMaxY: 735,
        hudFloorY: 132,
