...
- Active companion documents:
  ...
  - [`design_doc/conquest_optimization_state.md`](./conquest_optimization_state.md) — file map (lines, bytes, per-player multipliers, in-bundle status) + per-file function inventory
