...
- Event signature detail gap: `EventHandlerSignatures.md` confirms capture-event names, but per-event local signature files are not present in this core snapshot.
