## Project
This is a project to make a Conquest game mode for BF6

- This is the primary development folder: bf6-portal\dev\conquest
   - Almost all of our work will be done in here, and specifically bf6-portal\dev\conquest\src
   - Anything outside of this should be for reference only, unless explicitly called for to edit
