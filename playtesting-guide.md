...
- ❌ MAS 148
- ❌ M136 AT
- ❌ All pistols and primary weapons
- ❌ EOD Bot (during combat or for mine placement)

---

## Gearing Up (Pre-Combat)
...
> ⚠️ **You MUST receive the "Vehicle Registered" message when entering your vehicle!**

- If you don't see the message, **get out and get back in**
- **Best practice**: Enter your vehicle twice to ensure registration
- Registration messages are global — both teams can visually confirm
...
### During the Round
- **Do not return to main base** after leaving (until combat ends)
- Only **registered vehicles** that are destroyed count toward score
- You receive **2 supply crates** when leaving main base
- **Repair** your tank with the Engineer torch during combat
- **Stay close to your tank** — the abandonment range is small
- Straying too far = tank explodes = enemy point

### If Your Tank is Destroyed
- You are out for the round
- Return to main base OR do not redeploy
- Do not impact the outcome

### If You Die (But Tank Survives)
- Select redeploy
- Return to main base
- Do not continue fighting

### Team Repairs (2v2+)
- You can repair friendly tanks if close enough
...
- [BF6 2v2 Tanks Ladder](https://teamwarfare.net/ladders/bf6-2v2-tanks)
- [BF6 4v4 Vehicles Ladder](https://teamwarfare.net/ladders/bf6-4v4-vehicles)
