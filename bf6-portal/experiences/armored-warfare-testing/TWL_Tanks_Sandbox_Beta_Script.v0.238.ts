...
// version: 0.238 | Date: 02.01.26 | Time: 00:50 UTC
...
// Original Primary Authors: Polynorblu, UberDuberSoldat, Dox
...
/*
 * Paired Files with notes on improvements and testing: 
 * - src\OPTIMIZATION.md
 * - src\TESTER_GUIDE.md
 * 
 * Next Target: UI Polish: Bigger Triple Tap Dialog Help Text (readability)
 *
...
const VEHICLE_SPAWNER_KEEP_ALIVE_ABANDON_RADIUS = 10;
...
const VEHICLE_SPAWNER_BIND_DISTANCE_METERS = 15.0;
...
type MapKey = "Blackwell_Fields" | "Defense_Nexus" | "Golf_Course" | "Mirak_Valley" | "Operation_Firestorm" | "Liberation_Peak" | "Manhattan_Bridge";
...
const MAP_CONFIGS: Record<MapKey, MapConfig> = {
    ...
    Blackwell_Fields: {             
                                   //posX      posY      posZ 
        team1Base: mod.CreateVector(-151.364,  86.948,  -567.672), //West
        team2Base: mod.CreateVector( 388.231,  71.652,   136.54),  //East
    ...
    Defense_Nexus: {
                                   //posX      posY      posZ 
        team1Base: mod.CreateVector(-151.0862, 133.694,  428.018), //South?
        team2Base: mod.CreateVector(-107.727,  139.293,  123.248), //North?
        vehicleSpawnYawOffsetDeg: 0, 

        team1Spawns: [                            //posX      posY      posZ                             rotX      rotY      rotZ
            { slotNumber: 1, pos: mod.CreateVector(-185.503,  136.596,  454.617), rot: mod.CreateVector( 0.0,     -165.834,  0.0),       vehicle: mod.VehicleList.Abrams       },
        ...
        team2Spawns: [                            //posX      posY      posZ                             posX      posY      posZ
            { slotNumber: 1, pos: mod.CreateVector(-108.824,  138.815,  112.209), rot: mod.CreateVector( 0.0,     -44.984,   0.0),       vehicle: mod.VehicleList.Leopard      },
    ...
    Golf_Course: {
                                   //posX      posY      posZ 
        team1Base: mod.CreateVector(-764.508, 146.696, -856.193), //North
        team2Base: mod.CreateVector(-724.769, 141.317, -271.653), //South
        vehicleSpawnYawOffsetDeg: 0,

        team1Spawns: [                            //posX      posY      posZ                             rotX      rotY      rotZ
            { slotNumber: 1, pos: mod.CreateVector(-765.032,  146.068, -863.307), rot: mod.CreateVector( 0.0,     -21.908,   0.0),       vehicle: mod.VehicleList.Abrams       },
        ...
        team2Spawns: [                            //posX      posY      posZ                             posX      posY      posZ
            { slotNumber: 1, pos: mod.CreateVector(-722.800,  140.997, -275.980), rot: mod.CreateVector( 0.0,      138.357,  0.0),       vehicle: mod.VehicleList.Leopard      },
    ...
    Mirak_Valley: {
                                   //posX      posY      posZ 
        team1Base: mod.CreateVector(-505.641,  82.571,  -329.034), //West
        team2Base: mod.CreateVector( 428.32,   85.215,  -619.339), //East
        vehicleSpawnYawOffsetDeg: 0,
        ...
        team1Spawns: [                            //posX      posY      posZ                             rotX      rotY      rotZ
            ...
            { slotNumber: 2, pos: mod.CreateVector(-493.699,  82.167,  -330.616), rot: mod.CreateVector( 0.0,      87.0,     0.0),       vehicle: mod.VehicleList.M2Bradley    },
            { slotNumber: 3, pos: mod.CreateVector(-488.869,  82.556,  -340.723), rot: mod.CreateVector( 0.0,      85.0,     0.0),       vehicle: mod.VehicleList.Abrams       },
            { slotNumber: 4, pos: mod.CreateVector(-485.335,  83.244,  -351.327), rot: mod.CreateVector( 0.0,      84.500,   0.0),       vehicle: mod.VehicleList.M2Bradley    },
        ],
        team2Spawns: [                            //posX      posY      posZ                             posX      posY      posZ
            ...
            { slotNumber: 2, pos: mod.CreateVector( 412.416,  85.442,  -610.044), rot: mod.CreateVector( 0.0,     -45.580,   0.0),       vehicle: mod.VehicleList.CV90         },
            { slotNumber: 3, pos: mod.CreateVector( 400.396,  85.775,  -610.576), rot: mod.CreateVector( 0.0,     -47.719,   0.0),       vehicle: mod.VehicleList.Leopard      },
            { slotNumber: 4, pos: mod.CreateVector( 388.667,  86.085,  -611.596), rot: mod.CreateVector( 0.0,     -44.956,   0.0),       vehicle: mod.VehicleList.CV90         },
        ],
    },
    ...
    Operation_Firestorm: {
                                   //posX      posY      posZ 
        team1Base: mod.CreateVector( 570.692,  110.205, -232.341), //West
        team2Base: mod.CreateVector(-761.869,  133.091,  223.038), //East
        vehicleSpawnYawOffsetDeg: 0, //-40?
        ...
        team1Spawns: [                             //posX      posY      posZ                             rotX      rotY      rotZ
            ...
            { slotNumber: 2, pos: mod.CreateVector(-785.022,  132.973,  246.953), rot: mod.CreateVector( 0.0,      140.047,  0.0),       vehicle: mod.VehicleList.M2Bradley    },
            { slotNumber: 3, pos: mod.CreateVector(-775.140,  132.971,  255.312), rot: mod.CreateVector( 0.0,      143.879,  0.0),       vehicle: mod.VehicleList.Abrams       },
            { slotNumber: 4, pos: mod.CreateVector(-770.277,  132.971,  259.296), rot: mod.CreateVector( 0.0,      141.651,  0.0),       vehicle: mod.VehicleList.M2Bradley    },
        ...
        team2Spawns: [             //posX      posY      posZ                             posX      posY      posZ
            ...
            { slotNumber: 2, pos: mod.CreateVector( 608.379,  110.283, -233.569), rot: mod.CreateVector( 0.0,     -130.425,  0.0),       vehicle: mod.VehicleList.CV90         },
            { slotNumber: 3, pos: mod.CreateVector( 615.366,  110.283, -243.288), rot: mod.CreateVector( 0.0,     -124.187,  0.0),       vehicle: mod.VehicleList.Leopard      },
            { slotNumber: 4, pos: mod.CreateVector( 617.904,  110.297, -249.823), rot: mod.CreateVector( 0.0,     -125.702,  0.0),       vehicle: mod.VehicleList.CV90         },
        ],
    },
    ...
    Liberation_Peak: {
                                   //posX      posY      posZ 
        team1Base: mod.CreateVector(-323.365,  130.452,  83.211),  //West
        team2Base: mod.CreateVector( 281.887,  139.095,  464.187), //East
        vehicleSpawnYawOffsetDeg: 0,
    ...
    Manhattan_Bridge: {
                                   //posX      posY      posZ 
        team1Base: mod.CreateVector(-263.312,  52.308,  -460.612), //West
        team2Base: mod.CreateVector( 176.053,  57.474,  -243.843), //East
        vehicleSpawnYawOffsetDeg: 0,
...
// Cached per-vehicle spawn inference for later reconciliation on seat entry.
...
/* Dead function, not used anymore - can remove?
function deregisterVehicleFromAllTeams(vehicle: mod.Vehicle): void {
    mod.SetVariable(regVehiclesTeam1, arrayRemoveVehicle(mod.GetVariable(regVehiclesTeam1), vehicle));
    mod.SetVariable(regVehiclesTeam2, arrayRemoveVehicle(mod.GetVariable(regVehiclesTeam2), vehicle));
}
 */
    ...
    while (true) {
        ...
        for (let i = 0; i < State.vehicles.slots.length; i++) {
            ...
            if (!vehicle) {
                ...
                slot.vehicleId = -1;
                // Vehicle missing means destroyed/unspawned; schedule a respawn for its slot.
...
function createTeamSwitchUI(eventPlayer: mod.Player) {
    ...
    mod.AddUIButton(
        MATCHUP_DEC_ID,
        mod.CreateVector(125, matchupY, 0),
        mod.CreateVector(bestOfButtonSizeX, bestOfButtonSizeY, 0),
        mod.UIAnchor.TopRight,
        eventPlayer
    );
    const MATCHUP_DEC = mod.FindUIWidgetWithName(MATCHUP_DEC_ID, mod.GetUIRoot());
    mod.SetUIWidgetParent(MATCHUP_DEC, CONTAINER_BASE);
    ...
    const MATCHUP_DEC_LABEL = mod.FindUIWidgetWithName(MATCHUP_DEC_LABEL_ID, mod.GetUIRoot());
    mod.SetUIWidgetBgAlpha(MATCHUP_DEC_LABEL, 0);
    mod.SetUITextSize(MATCHUP_DEC_LABEL, 14);
    mod.SetUIWidgetParent(MATCHUP_DEC_LABEL, CONTAINER_BASE);
    ...
    mod.AddUIButton(
        MATCHUP_INC_ID,
        mod.CreateVector(-3, matchupY, 0),
        mod.CreateVector(bestOfButtonSizeX, bestOfButtonSizeY, 0),
        mod.UIAnchor.TopRight,
        eventPlayer
    );
    const MATCHUP_INC = mod.FindUIWidgetWithName(MATCHUP_INC_ID, mod.GetUIRoot());
    mod.SetUIWidgetParent(MATCHUP_INC, CONTAINER_BASE);
    ...
    const MATCHUP_INC_LABEL = mod.FindUIWidgetWithName(MATCHUP_INC_LABEL_ID, mod.GetUIRoot());
    mod.SetUIWidgetBgAlpha(MATCHUP_INC_LABEL, 0);
    mod.SetUITextSize(MATCHUP_INC_LABEL, 14);
    mod.SetUIWidgetParent(MATCHUP_INC_LABEL, CONTAINER_BASE);
...
function ensurePositionDebugWidgets(player: mod.Player): { x: mod.UIWidget; y: mod.UIWidget; z: mod.UIWidget; rotY: mod.UIWidget } | undefined {
    ...
    if (!container) {
        mod.AddUIContainer(
            containerId,
            mod.CreateVector(100, 17, 0), // +X to move left, +Y to move down
...
/* Dead Code: commenting out to be certain we can remove it, new path for coords is established through Admin Panel Button

function startAdminDebugLoop(player: mod.Player): void {
    if (State.admin.debugLoopActive) return;
    State.admin.debugLoopActive = true;
    debugLoop(player);
}

// This will call itself every 0.5 seconds.
function debugLoop(player: mod.Player): void {
    mod.Wait(5).then(() => {
        if (!player || !mod.IsPlayerValid(player)) {
            State.admin.debugLoopActive = false;
            return;
        }
        ...
        sendHighlightedWorldLogMessage(
            mod.Message(
                ...
                Math.floor(mod.XComponentOf(pos)),
                Math.floor(mod.YComponentOf(pos)),
                Math.floor(mod.ZComponentOf(pos))
            ),
            true,
            player
        );
        sendHighlightedWorldLogMessage(
            mod.Message(
                ...
                Math.floor(mod.XComponentOf(facing)),
                Math.floor(mod.YComponentOf(facing)),
                Math.floor(mod.ZComponentOf(facing))
            ),
            true,
            player
        );
...
export function OnPlayerEnterVehicle(eventPlayer: mod.Player, eventVehicle: mod.Vehicle) {
    ...
    // Transfer on missing owner or cross-team registry mismatch.
    const shouldTransferOwnership = !priorOwnerValid || (registeredTeam !== 0 && registeredTeam !== teamNum); 
    ...
    if (shouldTransferOwnership) {
        ...
        // Same-team passenger entry: keep current owner and avoid noisy messaging.
        return;
    }
    ...
    if (!wasRegistered) { //New Vehicle
        ...
        const messageKey = (registeredTeam !== 0 && registeredTeam !== teamNum)
            ? STR_VEHICLE_STOLEN_REGISTER
            : mod.stringkeys.twl.messages.vehicleReturned;
        sendHighlightedWorldLogMessage(
            mod.Message(messageKey, eventPlayer, teamNameKey), 
            true,
            mod.GetTeam(TeamID.Team1)
        );
        sendHighlightedWorldLogMessage(
    ...
    } else { //Old Vehicle Different Player
        const messageKey = (registeredTeam !== 0 && registeredTeam !== teamNum)
            ? STR_VEHICLE_STOLEN_REGISTER
            : mod.stringkeys.twl.messages.vehicleReRegistered;
        sendHighlightedWorldLogMessage(
            mod.Message(messageKey, teamNameKey, eventPlayer), 
            true,
            mod.GetTeam(TeamID.Team1)
        );
        sendHighlightedWorldLogMessage(
...
export async function OnVehicleSpawned(eventVehicle: mod.Vehicle): Promise<void> {
    ...
    const slotIndex = findSpawnerSlotByPosition(posObject);
    if (slotIndex >= 0) {
        const slot = State.vehicles.slots[slotIndex];
        if (!slot.enabled) {
    ...
    // Bail out if the vehicle didn't spawn near a known team base (keeps registration clean).
...
// EOF version: 0.238 | Date: 02.01.26 | Time: 00:50 UTC
